...
[audio_signal, fs] = audioread(sprintf('digital_mic%d.wav', inputIndex));  % Load audio signals
...
save_file_name = sprintf('Bandpass_output_mic%d.wav', inputIndex);
audiowrite(save_file_name, filtered_signal, fs);  % This writes the signal as .wav
